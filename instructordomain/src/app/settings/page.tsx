      ...
      <SidebarInset className="bg-muted/10">
        <header className="flex h-16 shrink-0 items-center gap-4 border-b bg-background px-6 border-amber-200/40 dark:border-amber-500/10">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground font-medium">Orchestration branding and configurations</p>
          </div>
        </header>
        ...
        <main className="p-6 md:p-8 max-w-2xl mx-auto w-full flex items-center justify-center min-h-[70vh]">
          <Card className="border-amber-500/30 dark:border-amber-500/20 shadow-2xl rounded-[2.5rem] bg-background text-center p-8 space-y-6">
            ...
            <CardContent className="text-sm text-muted-foreground leading-relaxed">
              To update the platform branding, please log into the <strong>Support Console (Admin Console)</strong> and navigate to the <strong>Brand Orchestration</strong> page. Changes made there will propagate to all main and instructor domain interfaces automatically.
            </CardContent>
          </Card>
        </main>
      </SidebarInset>
