      ...
      <AnimatePresence mode="wait">
        {isPending ? (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="page-transition-loader absolute inset-0 z-40 bg-background flex flex-col items-center justify-center overflow-hidden"
          >
            <motion.div
            ...
            >
              ...
              {hasSocials && (
                <div className="flex items-center justify-center gap-4 pt-6 border-t border-muted w-48 text-muted-foreground z-[999] pointer-events-auto">
                  {instagram && (
